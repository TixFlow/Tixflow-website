  ...
  return (
    <div className="bg-gray-100">
      <div className="flex px-10 py-4">
        <div className="w-3/8 bg-white rounded-lg p-4 px-10 mx-3 text-sm leading-relaxed">
          ...
          <p className="mb-2">
            Bạn đã từng mua vé mà không thể tham gia sự kiện? Hay bỏ lỡ một show
            diễn chỉ vì vé đã "sold out"? Với Tixflow, bạn có thể:
          </p>
